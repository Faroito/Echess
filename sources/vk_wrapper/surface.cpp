...
void Surface::setUp(VkInstance &instance, GLFWwindow *window) {
...
bool Surface::isDeviceSuitable(VkPhysicalDevice device) {
...
bool Surface::checkDeviceExtensionSupport(VkPhysicalDevice device) {
