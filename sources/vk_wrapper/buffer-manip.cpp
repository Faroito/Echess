...
void BufferManip::createBuffer(vk_wrapper::Devices &devices, VkDeviceSize size, VkBufferUsageFlags usage,
...
void BufferManip::copyBuffer(vk_wrapper::Devices &devices, VkCommandPool &pool, VkBuffer srcBuffer,
...
VkCommandBuffer BufferManip::beginSingleTimeCommands(VkDevice &device, VkCommandPool &pool) {
...
void BufferManip::endSingleTimeCommands(vk_wrapper::Devices &devices, VkCommandPool &pool,
                                        VkCommandBuffer commandBuffer) {
...
void BufferManip::createImage(Devices &devices, uint32_t width, uint32_t height, VkFormat format,
...
VkImageView BufferManip::createImageView(VkDevice &device, VkImage image, VkFormat format,
...
void BufferManip::copyBufferToImage(Devices &devices, VkCommandPool &pool, VkBuffer buffer,
...
void BufferManip::transitionImageLayout(Devices &devices, VkCommandPool &pool, VkImage image,
